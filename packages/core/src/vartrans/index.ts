...
export interface TerminologicalRelation extends Omit<LexicoSemanticRelation, "@type"> {
...
export interface ConceptualRelation extends Omit<LexicoSemanticRelation, "@type"> {
